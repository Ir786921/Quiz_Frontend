...
const CaptureImage = () => {
  ...
  return (
    <div className="row ">
      <div className="col-md-6 tw-p-2 tw-flex tw-justify-center tw-border-r-2 tw-border-black">
...
<br />
      ...
      <h4 className=" tw-px-3 tw-text-sm tw-text-gray-400">Please Center yourself to the screen and press "capture your face" button</h4>
